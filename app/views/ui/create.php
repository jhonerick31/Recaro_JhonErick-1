...
<body>
    <div class="card">
        ...
        <!-- Display error message if duplicate email or other issues -->
        ...
        <form method="post" action="/students/create" enctype="multipart/form-data">
            ...
            <input type="text" name="first_name" required value="<?= htmlspecialchars($_POST['first_name'] ?? '') ?>"><br>

            <label>Last Name:</label><br>
            <input type="text" name="last_name" required value="<?= htmlspecialchars($_POST['last_name'] ?? '') ?>"><br>
